...
#C
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread-mgw8-mt-x32-1_76
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread-mgw8-mt-d-x32-1_76
#C++
win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread-mgw8-mt-x32-1_76.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread-mgw8-mt-d-x32-1_76.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/boost_thread-mgw8-mt-x32-1_76.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/boost_thread-mgw8-mt-d-x32-1_76.lib
} else: { # x64
#C
win32:CONFIG(release, debug|release): LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread-mgw8-mt-x64-1_76
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread-mgw8-mt-d-x64-1_76
#C++
win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread-mgw8-mt-x64-1_76.a
else:win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread-mgw8-mt-d-x64-1_76.a
else:win32:!win32-g++:CONFIG(release, debug|release): PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/boost_thread-mgw8-mt-x64-1_76.lib
else:win32:!win32-g++:CONFIG(debug, debug|release): PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/boost_thread-mgw8-mt-d-x64-1_76.lib
}
}
...
contains(QT_ARCH, armeabi-v7a) {
    ...
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread-clang-mt-a32-1_76
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread-clang-mt-a32-1_76.a
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_chrono-clang-mt-a32-1_76
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_chrono-clang-mt-a32-1_76.a
    ...
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread-clang-mt-a64-1_76
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread-clang-mt-a64-1_76.a
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_chrono-clang-mt-a64-1_76
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_chrono-clang-mt-a64-1_76.a
    ...
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread-clang-mt-x32-1_76
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread-clang-mt-x32-1_76.a
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_chrono-clang-mt-x32-1_76
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_chrono-clang-mt-x32-1_76.a
    ...
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread-clang-mt-x64-1_76
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread-clang-mt-x64-1_76.a
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_chrono-clang-mt-x64-1_76
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_chrono-clang-mt-x64-1_76.a
}
...
unix:!android {
    ...
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_thread
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_thread.so
    LIBS += -L$$PWD/../../boost_1_76_0/stage/lib/ -lboost_chrono
    PRE_TARGETDEPS += $$PWD/../../boost_1_76_0/stage/lib/libboost_chrono.so
