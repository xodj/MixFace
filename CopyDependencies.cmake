...
if(NOT CMAKE_BUILD_TYPE MATCHES "Debug" AND  MSVC)
...
if(MINGW)
    ...
    configure_file(${CMAKE_PREFIX_PATH}/plugins/platforms/qwindows.dll ${PROJECT_BINARY_DIR}/Appfolder/Platforms/qwindows.dll COPYONLY)
    configure_file(${CMAKE_PREFIX_PATH}/plugins/styles/qwindowsvistastyle.dll ${PROJECT_BINARY_DIR}/Appfolder/Styles/qwindowsvistastyle.dll COPYONLY)
    configure_file(${CMAKE_PREFIX_PATH}/bin/libstdc++-6.dll ${PROJECT_BINARY_DIR}/Appfolder/libstdc++-6.dll COPYONLY)
    configure_file(${CMAKE_PREFIX_PATH}/bin/libwinpthread-1.dll ${PROJECT_BINARY_DIR}/Appfolder/libwinpthread-1.dll COPYONLY)
    configure_file(${CMAKE_PREFIX_PATH}/bin/libgcc_s_seh-1.dll ${PROJECT_BINARY_DIR}/Appfolder/libgcc_s_seh-1.dll COPYONLY)
endif(MINGW)
