...
void wxC26FAInitBitmapResources()
{
    ...
    XRC_ADD_FILE(wxT("XRC_resource/mf_bitmaps.cpp$C__GitHub_MixFace_MixFaceWXWidgets_mf_bitmaps.xrc"), xml_res_file_0, xml_res_size_0, wxT("text/xml"));
    wxXmlResource::Get()->Load(wxT("memory:XRC_resource/mf_bitmaps.cpp$C__GitHub_MixFace_MixFaceWXWidgets_mf_bitmaps.xrc"));
}
